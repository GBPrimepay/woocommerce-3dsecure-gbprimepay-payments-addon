        ...
        class AS_Gbprimepay_ACCOUNT extends WC_Settings_Page
    {
            ...
            public function get_settings($current_section = '')
        {
                ...
                $settings = apply_filters('as_gbprimepay_account_settings', array(
                    ...
                    'static_link' => array(
                        'title' => __('GBPrimePay Static Link', 'gbprimepay-payment-gateways'),
                        'desc' => __('Enable GBPrimePay Static Link', 'gbprimepay-payment-gateways'),
                        'type' => 'checkbox',
                        'checkboxgroup' => 'start',
                        'show_if_checked' => 'option',
                        'default' => 'no',
                        'desc_tip' => __('' . $_txtStaticLink, 'gbprimepay-payment-gateways'),
                        'id' => 'gbprimepay_account_settings[static_link]',
                    ),
                    'Logging' => array(
